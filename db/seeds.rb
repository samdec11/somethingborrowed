...
u1 = User.create(name:"Jane", email:"janesternbach+2@gmail.com", password:"abc", password_confirmation:"abc", address:"251 W 98th St, New York, NY", phone: '(212) 867-5309')
u2 = User.create(name:"Sean", email:"janesternbach+1@gmail.com", password:"abc", password_confirmation:"abc", address:"10 E 21st St, New York, NY", phone: '(212) 867-5309')
u3 = User.create(name:"Bob", email:"janesternbach+3@gmail.com", password:"abc", password_confirmation:"abc", address:"40 Charlton St, New York, NY", phone: '(212) 867-5309')
u4 = User.create(name:"Sue", email:"janesternbach+4@gmail.com", password:"abc", password_confirmation:"abc", address:"90 Park Ave, New York, NY", phone: '(212) 867-5309')
